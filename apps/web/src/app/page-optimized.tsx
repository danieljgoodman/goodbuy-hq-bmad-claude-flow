  ...
  return (
    <div className="min-h-screen bg-background scroll-smooth">
      ...
      <main role="main" aria-label="GoodBuy business valuation homepage" className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        ...
        {/* OPTIMIZED HERO SECTION - Single Primary CTA */}
        <section ref={heroRef} aria-labelledby="hero-heading" className="text-center mb-20 lg:mb-24">
          ...
          <div className="relative mb-16">
            ...
            {/* Reduced cognitive load - cleaner hero */}
            <div className="relative z-10 space-y-8 pt-8">
              ...
              <div className="space-y-6">
                <h1 id="hero-heading" className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-foreground leading-tight tracking-tight max-w-5xl mx-auto">
                  Know What Your Business
                  <span className="block bg-gradient-to-r from-primary via-primary to-primary/90 bg-clip-text text-transparent mt-2">
                    Is Really Worth
                  </span>
                </h1>
              ...
              <div id="cta-description" className="text-center text-sm text-muted-foreground pt-4">
