...
- [ ] Professional tier prompts generate investment-grade analysis with specific ROI calculations
- [ ] Enterprise tier prompts produce strategic consultant-level insights with scenario analysis
- [ ] Tier-appropriate analysis depth matches subscription level without exposing higher-tier insights
- [ ] Quantified recommendations include specific investment amounts, timelines, and valuation impact
- [ ] Advanced prompting techniques utilize few-shot learning and chain-of-thought reasoning
- [ ] Context-aware analysis leverages all tier-specific questionnaire data comprehensively
- [ ] Industry-agnostic methodology works effectively across different business types
- [ ] Consistent professional language maintains credibility and builds user trust
- [ ] Seamless integration with existing Claude API workflow and report generation system
- [ ] Optimized prompt efficiency minimizes token usage while maximizing analysis quality
- [ ] Reliable analysis generation with error handling and fallback strategies implemented
- [ ] Real-time analysis capabilities support dashboard insights and scenario modeling
- [ ] Comprehensive testing validates analysis quality against expert benchmarks
- [ ] Performance monitoring ensures consistent analysis quality and user satisfaction
